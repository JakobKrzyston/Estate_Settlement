...
The app is served at [http://localhost](http://localhost) (port 80). The backend health check is available at [http://localhost/health](http://localhost/health). See [docker-compose.yml](docker-compose.yml) for details.
